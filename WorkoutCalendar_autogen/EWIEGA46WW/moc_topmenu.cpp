...
struct qt_meta_stringdata_topMenu_t {
    QByteArrayData data[1];
    char stringdata0[8];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_topMenu_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_topMenu_t qt_meta_stringdata_topMenu = {
    {
QT_MOC_LITERAL(0, 0, 7) // "topMenu"
...
QT_INIT_METAOBJECT const QMetaObject topMenu::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_topMenu.data,
    qt_meta_data_topMenu,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *topMenu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_topMenu.stringdata0))
